...
import de.hrw.actor.util.Counter;
import de.hrw.actor.util.ScoreBoard;
import de.shirscher.export.Export;

/**
 * This is Earth. Or at least some remote, uninhabited part of Earth. Here,
 * Greeps can land and look for piles of tomatoes...
 * 
...
public class Earth extends World {
	...
	private int[][][] mapData = { { { 480, 100, 0 }, { 40, 721, 532 }, { 12, 400, 560 }, { 40, 615, 400 }, // map
																											// 1
			{ 40, 642, 192 }, { 16, 128, 113 }, { 30, 400, 40 } },

	{ { 496, 709, 0 }, { 10, 322, 422 }, { 40, 700, 241 }, { 40, 681, 49 }, // map
																			// 2
			{ 10, 317, 54 }, { 50, 90, 174 }, { 40, 60, 339 } },

	{ { 272, 394, 0 }, { 10, 39, 30 }, { 30, 71, 476 }, { 50, 398, 520 }, // map
																			// 3
			{ 40, 655, 492 } }, };
	...
	public Earth() {
		...
		showMap(currentMap);
		Export.executeExport(Greep.getAuthorName());
	}

	/**
	 * Return true, if the specified coordinate shows water. (Water is defined
	 * as a predominantly blueish color.)
	 */
	...
	private void showMap(int mapNo) {
		map = new GreenfootImage("images/map" + mapNo + ".jpg");
		setBackground(map);
