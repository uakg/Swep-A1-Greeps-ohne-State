package de.hrw.actor;

import greenfoot.Actor;
import de.hrw.actor.greep.Creature;
import de.hrw.actor.greep.Greep;
import de.hrw.actor.util.Counter;
import de.hrw.actor.util.Timer;

/**
 * A space ship. It comes from space, lands, and releases some Greeps into the
 * world.
 * 
...
public class Ship extends Actor {
	...
	private int totalPassengers = 20; // Total number of passengers in this
										// ship.
	private int passengersReleased = 0; // Number of passengers that left so
										// far.
